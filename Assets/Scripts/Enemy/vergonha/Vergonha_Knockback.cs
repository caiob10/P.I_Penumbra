...
public class Vergonha_Knockback : MonoBehaviour
{
    ...
    Player_Movement pm;
    Player_Status ps;// pode ser util em um futuro ajsute de colisoes
     ...
     void Awake()
    {
        ...
        if (Player == null)
        {
            ...
            if (playerObj != null)//se conseguir pegar o player
            {
                ...
                pm = playerObj.GetComponent<Player_Movement>();
            }
        }
    }
    ...
    public IEnumerator knockback(Vector2 direcao, float tempo)
    {
        ...
        Vector2 forcaExtra = new Vector2(direcao.x, empurrao * 0.15f);// uma força extra para cima sem mechar no eixo X
