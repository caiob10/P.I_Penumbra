...
public class Platforms_PingPongY : MonoBehaviour
{
    Vector2 PosicaoAx; // vetor para receber posição atual
    Vector2 PosicaoBx; // recebe posição atual+ deslocamento
    Vector2 Deslocamento = new Vector2(0, 25);
    

    float Velocidade = 0.1f; // velocidade de movimento
    ...
    void Update()
    {
        ...
        transform.position = Vector2.Lerp(PosicaoAx, PosicaoBx, 1 - pingPong); // coloquei invertido pra não esquecer de como inverter
    }
